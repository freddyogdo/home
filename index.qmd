...
::: {.section-lead}
The central purpose of this space is simple: to share applied knowledge and contribute to a more rigorous understanding of financial and economic systems. The underlying idea is that models and research should not be limited to parameter estimation; they should also explain mechanisms, support decision-making, and contribute to the development of intelligent analytical systems.
:::
...
Objective: combine quantitative research, production-grade pipelines, and high-performance implementation.
:::

::: {.q-card .span-4}
### Research systems

Research standards, Quarto, Git/GitHub, LaTeX and reproducible reports.
:::

::: {.q-card .span-4}
### Data and modeling

Time-series data, high-frequency financial indicators, feature engineering, backtesting, model diagnostics, database integration, and automated reporting.
:::
...
Selected technical research and analytical notes that I have authored or co-authored, focused on financial stability, deposit dynamics, credit conditions, macro-financial linkages, and structural changes in the Dominican financial system.
:::
